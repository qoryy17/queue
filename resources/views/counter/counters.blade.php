        ...
        <div class="pc-content">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('counters.form', ['param' => 'add', 'id' => Crypt::encrypt('null')]) }}"
                        class="btn btn-primary">
                        <i class="ti ti-building-bank"></i> Add New Counter
                    </a>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex-shrink-0">
                                                <a href="{{ route('counters.form', ['param' => 'edit', 'id' => Crypt::encrypt($item->id)]) }}"
                                                ...
                                                <form id="deleteForm{{ $no }}"
                                                    action="{{ route('counters.delete', ['id' => Crypt::encrypt($item->id)]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
